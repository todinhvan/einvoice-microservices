...
initTracing(ServiceName.PAYMENT);
...
async function bootstrap() {
  ...
  app.connectMicroservice<MicroserviceOptions>({
    ...
    options: {
      host: AppModule.Configuration.TCP_CONFIG.TCP_PAYMENT.options.host,
      port: AppModule.Configuration.TCP_CONFIG.TCP_PAYMENT.options.port,
    },
  });
